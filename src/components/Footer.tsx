      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left mb-16">
          ...
          <div className="flex flex-col gap-5 text-[11px] uppercase tracking-[0.2em] font-bold">
            ...
            <a href="tel:+525519406598" className="hover:text-background/70 transition-colors flex items-center justify-center md:justify-start gap-3">
              <Phone className="w-4 h-4 text-secondary" /> +52 (55) 1940 6598
            </a>
          </div>
          ...
          <div className="flex flex-col gap-5 text-[11px] uppercase tracking-[0.2em] font-bold">
            ...
            <Link href={`/${locale}/aviso-de-privacidad`} className="hover:text-background/70 transition-colors"><T>Aviso de Privacidad</T></Link>
            <Link href={`/${locale}/terminos-y-condiciones`} className="hover:text-background/70 transition-colors"><T>Términos y Condiciones</T></Link>
            <Link href={`/${locale}/politica-de-cancelacion`} className="hover:text-background/70 transition-colors"><T>Política de Reembolsos y Cancelaciones</T></Link>
          </div>
        </div>
